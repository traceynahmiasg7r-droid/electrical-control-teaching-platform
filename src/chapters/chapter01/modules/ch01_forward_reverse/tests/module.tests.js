...
const renderer = platform.moduleRenderers.createCh01ForwardReverseRenderer();
renderer.render({ root: renderRoot, internalState: { power: "closed", direction: "forward" }, solverResult: {} });
...
renderer.render({ root: renderRoot, internalState: { power: "closed", direction: "reverse" }, solverResult: {} });
